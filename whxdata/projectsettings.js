...
rh.consts('DEFAULT_TOPIC', encodeURI(""));
rh.consts('HOME_FILEPATH', encodeURI('index.htm'));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', '0dd9cf0e-f9ea-4615-bce8-2d5a91cd10ed' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "Estimate Actual");
model.publish(rh.consts('PDF_FILE_NAME'), "");
model.publish(rh.consts('MAX_SEARCH_RESULTS'), "20");
model.publish(rh.consts('KEY_SKIN_FOLDER_NAME'), "Test_Skin_PC");
